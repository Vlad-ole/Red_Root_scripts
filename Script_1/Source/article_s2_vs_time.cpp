...
void article_s2_vs_time()
{
//    vector<double> x{0.028, 0.823, 1.087, 1.387, 1.771, 7.379, 8.049};
//    vector<double> x_fields1{0.077, 0.872, 1.137, 1.437, 1.820, 0.178, 0.849};

    vector<double> x_0_bub{0.028, 0.823, 1.087, 1.387, 1.771};
    vector<double> x_1_bub{7.379, 8.049};

    vector<double> x_all_field{0.065, 0.089, 0.872, 1.137, 1.437, 1.820, 0.169, 0.187, 0.849, 1.625, 1.999, 3.991};
    vector<double> x_0_field{0.065, 0.089, 0.872, 1.137, 1.437, 1.820};
    vector<double> x_1_field{0.169, 0.187, 0.849, 1.625, 1.999, 3.991, 6.667, 6.716, 6.872, 7.692, 7.773, 7.865, 7.888, 7.910};

    vector<double> y_0_center{13138.6, 13236.7, 13425.8, 13348.9, 13203.3, 13284};
    vector<double> y_1_center{13376.2, 13419.7, 13281, 13346.2, 13299.4, 13225.4, 13206.6, 13221.6, 13141.1, 13286.8, 12996.4, 13093.5, 13356.6, 13323};

    vector<double> s1_0_center{642.126, 638.926, 638.59, 641.732, 639.091, 639.488};
    vector<double> s1_1_center{641.717, 643.471, 640.145, 642.774, 638.635, 639.902, 639.637, 637.587, 635.426, 640.41, 638.722, 641.539, 639.278, 637.416};

    vector<double> s1_0_border{647.791, 648.142, 648.571, 649.681, 648.265, 648.498};
    vector<double> s1_1_border{651.562, 651.741, 649.01, 650.573, 647.142, 647.187, 648.279, 647.544, 644.768, 648.457, 648.115, 652.135, 646.439, 644.112};

    vector<double> y_all_border{9406.21, 9267.79, 11534.9, 11766.6, 11935.3, 12116.3, 10176, 10327, 11545.5, 12080, 12195.6, 12408};
    vector<double> y_0_border{9406.21, 9267.79, 11534.9, 11766.6, 11935.3, 12116.3};
    vector<double> y_1_border{10176, 10327, 11545.5, 12080, 12195.6, 12408, 12768.7, 12728.1, 12701.1, 12813.5, 12768.5, 12787.4, 12032.8, 11818.2};

    vector<string> x_1_field_text{"1236", ".", "1238", "1239", "1240", "1242", "1246", "1247", "1248", "1249, R=+86", "1251, R=+16", "1253, R=+16", "1254, R=+156", "1255, R=+226"};

//    vector<double> y1{13186.1, 13425.8, 13348.9, 13203.3, 13284, 13398.2, 13281};
//    vector<double> y2{9336.85, 11534.9, 11766.6, 11935.3, 12116.3, 10290.6, 10831.4};
